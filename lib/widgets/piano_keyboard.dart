...
class _PianoKeyboardState extends State<PianoKeyboard> {
  ...
  // Helper method to check if a note is highlighted
  bool _isNoteHighlighted(int midiNote) {
    return widget.highlightedNote == midiNote;
  }

  // Get color for white key
  Color _getWhiteKeyColor(int midiNote) {
    if (_pressedKeys.contains(midiNote)) {
      return Theme.of(context).colorScheme.primaryContainer;
    } else if (_isNoteHighlighted(midiNote)) {
  ...
  // Get color for black key
  Color _getBlackKeyColor(int midiNote) {
    if (_pressedKeys.contains(midiNote)) {
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text('${widget.numberOfOctaves} octaves (${widget.startingOctave}-${widget.startingOctave + widget.numberOfOctaves - 1})',
